function getBotResponse(input) {
    ...
    if (((input.search("accounts") != -1) || (input.search("account") != -1) )&& ((input.search("savings") == -1)||(input.search("saving") == -1)) && (input.search("current") == -1)) {
    ...
    }else if ((((input.search("accounts") != -1) || (input.search("account") != -1) ) )&& (((input.search("savings") != -1)||(input.search("saving") != -1))) &&( (input.search("documents") != -1)|| (input.search("document") != -1)||(input.search("documents required") != -1)||(input.search("documents for opening saving account") != -1)||(input.search("opening saving account documents") != -1))&& (input.search("proprietorship") == -1)) {
    ...
    }else if (((input.search("accounts") != -1) || (input.search("account") != -1)) && (input.search("current") != -1) && (input.search("savings") == -1)&& (input.search("proprietorship") == -1)&& (input.search("partnership") == -1)) {
        ...
        responses = "1.Form 49 A along with Form 60 if applied for PAN \n 2. address proof \n3. Pan card \n 4. passport sized photo \n 5.Account opening Cheque from existing Savings/Individual Current Account"   ;
    }else if (((input.search("accounts") != -1) || (input.search("account") != -1) ) && (input.search("current") != -1) && (input.search("documents") != -1)  && (input.search("partnership") != -1)) {
        responses = "1. Partnership deed \n 2. Address proof of partnrship firm \n3. Pan card in the name of partnership firm \n 4. Identity Proof of all Partners \n 5.Partnership Registration Certificate (if Registered Partnership)"   ;
    }
    else{
        // Greetings
